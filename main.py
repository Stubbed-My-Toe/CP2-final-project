# main.py — Cleek Casino main menu
import sys
import pygame
import math
...
def main_menu(win, data, csv_file):
    ...
    running = True
    while running:
        cash = float(helper.csv_get_data(csv_file,
        ...
        for e in events:
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and e.button == 1:
                ...
                if idx >= 0:
                    ...
                    data = helper.csv_get_data(csv_file,
                               {"username": data["username"],
...
def main():
    ...
    csv_file = helper.csv_file("data_storage.csv")

    while True:
        data = auth.login_screen(win, csv_file)
        if data is None:
            break
